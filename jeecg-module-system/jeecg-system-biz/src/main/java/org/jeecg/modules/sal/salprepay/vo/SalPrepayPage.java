package org.jeecg.modules.sal.salprepay.vo;
 ...
 */
@Data
@ApiModel(value="sal_prepayPage对象", description="销售预收")
public class SalPrepayPage {
...
@Dict(dictTable = "sys_user",dicText = "realname",dicCode = "username")
	...
	@ApiModelProperty(value = "预收使用_明细")
	private List<SalPrepayDetail> salPrepayDetailList;

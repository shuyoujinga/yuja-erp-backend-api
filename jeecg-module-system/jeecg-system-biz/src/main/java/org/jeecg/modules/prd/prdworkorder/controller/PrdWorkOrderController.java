...
public class PrdWorkOrderController {
	...
	@DeleteCheckAudit(service = IPrdWorkOrderService.class,entity = PrdWorkOrder.class)
    ...
    */
    ...
    public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
	  ...
	  * @return
	  */
	 @AutoLog(value = "生产计划-审核/反审核")
	 @ApiOperation(value = "生产计划-审核/反审核", notes = "生产计划-审核/反审核")
	 @RequiresPermissions("prdworkorder:prd_work_order:audit")
	 ...
	 public Result<String> audit(@RequestBody AuditRequest auditRequest) {
		 ...
		 if (Constants.DICT_AUDIT_FLAG.AUDIT.equals(type)) {
			 count = prdWorkOrderService.audit(ids);
		 } else {
			 count = prdWorkOrderService.unAudit(ids);
		 }

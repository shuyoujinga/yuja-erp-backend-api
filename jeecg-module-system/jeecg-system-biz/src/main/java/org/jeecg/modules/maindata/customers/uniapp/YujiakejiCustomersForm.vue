    ...
    <view>
		...
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">简称：</text></view>
                  <input  placeholder="请输入简称" v-model="model.shortName"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/customers/yujiakejiCustomers/queryById",
                  add: "/customers/yujiakejiCustomers/add",

 ...
 * @Version: V1.0
 */
@ApiModel(value="sal_biz_plan对象", description="业务计划")
@Data
@TableName("sal_biz_plan")
public class SalBizPlan implements Serializable {
    ...
    /**业务计划类型*/
    @Excel(name = "计划类型", width = 15,dicCode = "dict_biz_plan_type")
    @ApiModelProperty(value = "计划类型")
    @Dict(dicCode = "dict_biz_plan_type")
    private Integer bizPlanType;
    /**状态*/

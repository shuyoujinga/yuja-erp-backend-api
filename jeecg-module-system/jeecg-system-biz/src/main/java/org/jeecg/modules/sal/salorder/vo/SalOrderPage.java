package org.jeecg.modules.sal.salorder.vo;
 ...
 */
@Data
@ApiModel(value="sal_orderPage对象", description="销售订单")
public class SalOrderPage {
...
@Dict(dictTable = "sys_user",dicText = "realname",dicCode = "username")
	...
	@ExcelCollection(name="销售订单_明细")
	@ApiModelProperty(value = "销售订单_明细")
	private List<SalOrderDetail> salOrderDetailList;

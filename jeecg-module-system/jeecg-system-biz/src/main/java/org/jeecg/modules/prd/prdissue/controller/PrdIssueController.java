...
public class PrdIssueController {
	...
	@DeleteCheckAudit(service = IPrdIssueService.class,entity = PrdIssue.class)
	...
	//@AutoLog(value = "生产领料_明细通过主表ID查询")
	@ApiOperation(value="生产领料_明细主表ID查询", notes="生产领料_明细-通主表ID查询")
	@GetMapping(value = "/queryPrdIssueDetailByTargetId")
	public Result<List<PrdIssueDetail>> queryPrdIssueDetailByTargetId(@RequestParam(name="id",required=true) String id) {
		List<PrdIssueDetail> prdIssueDetailList = prdIssueDetailService.selectByTargetId(id);
		return Result.OK(prdIssueDetailList);
	}
    ...
    */
    ...
    public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
	 ...
	 @RequiresPermissions("prdissue:prd_issue:audit")
	 ...
	 public Result<String> audit(@RequestBody AuditRequest auditRequest) throws Exception {
		 ...
		 if (Constants.DICT_AUDIT_FLAG.AUDIT.equals(type)) {
			 count = prdIssueService.audit(ids);
		 } else {
			 count = prdIssueService.unAudit(ids);
		 }

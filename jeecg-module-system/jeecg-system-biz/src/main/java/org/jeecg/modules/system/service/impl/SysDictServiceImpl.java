...
//	}
	...
	public List<DictModel> getDictItems(String dictCode) {
		...
		if (dictCode.contains(SymbolConstant.COMMA)&&!dictCode.contains(SymbolConstant.DIY_DICT_CURRENT)) {
			//关联表字典（举例：sys_user,realname,id）
		...
		if (dictCode.contains(SymbolConstant.DIY_DICT_CURRENT)) {
			...
			if (dictCode.contains(DIY_DICT_CONSTANT.WAREHOUSE)){
				ls=this.queryDictItemsByDiyCode(DIY_DICT_CONSTANT.WAREHOUSE_SQL);
			}
		}

package org.jeecg.modules.sal.salreceipt.entity;
 ...
 * @Version: V1.0
 */
@ApiModel(value="sal_receipt_detail对象", description="销售收款_明细")
@Data
@TableName("sal_receipt_detail")
public class SalReceiptDetail implements Serializable {

package org.jeecg.modules.prd.prdworkorder.entity;
 ...
 * @Version: V1.0
 */
@ApiModel(value="prd_work_order_detail对象", description="生产工单_物料明细")
@Data
@TableName("prd_work_order_detail")
public class PrdWorkOrderDetail implements Serializable {

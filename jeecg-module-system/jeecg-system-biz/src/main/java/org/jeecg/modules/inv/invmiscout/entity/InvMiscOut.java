package org.jeecg.modules.inv.invmiscout.entity;
 ...
 * @Version: V1.0
 */
@ApiModel(value="inv_misc_out对象", description="其他出库")
@Data
@TableName("inv_misc_out")
public class InvMiscOut implements Serializable {
	...
	/**出库类型*/
	@Excel(name = "出库类型", width = 15,dicCode = "dict_other_out_type")
    @ApiModelProperty(value = "出库类型")
    @Dict(dicCode = "dict_other_out_type")

package org.jeecg.modules.sal.saldelivery.vo;
 ...
 */
@Data
@ApiModel(value="sal_deliveryPage对象", description="销售出货")
public class SalDeliveryPage {
	...
	@ApiModelProperty(value = "销售发货_明细")
	private List<SalDeliveryDetail> salDeliveryDetailList;

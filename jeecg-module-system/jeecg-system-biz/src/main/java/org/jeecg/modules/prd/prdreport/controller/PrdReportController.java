...
public class PrdReportController {
    ...
    */
    ...
    public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
	  ...
	  * @return
	  */
	 @AutoLog(value = "生产报工-审核/反审核")
	 @ApiOperation(value = "生产报工-审核/反审核", notes = "生产报工-审核/反审核")
	 @RequiresPermissions("prdreport:prd_report:audit")
	 ...
	 public Result<String> audit(@RequestBody AuditRequest auditRequest) throws Exception {
		 ...
		 if (Constants.DICT_AUDIT_FLAG.AUDIT.equals(type)) {
			 count = prdReportService.audit(ids);
		 } else {
			 count = prdReportService.unAudit(ids);
		 }

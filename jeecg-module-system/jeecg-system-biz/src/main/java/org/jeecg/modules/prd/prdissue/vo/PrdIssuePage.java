package org.jeecg.modules.prd.prdissue.vo;
 ...
 */
@Data
@ApiModel(value="prd_issuePage对象", description="生产领料")
public class PrdIssuePage {
...
@Dict(dictTable = "sys_user",dicText = "realname",dicCode = "username")
	...
	@ExcelCollection(name="生产领料_明细")
	@ApiModelProperty(value = "生产领料_明细")
	private List<PrdIssueDetail> prdIssueDetailList;

package org.jeecg.modules.inv.invassembly.vo;
 ...
 */
@Data
@ApiModel(value="inv_assemblyPage对象", description="组装单")
public class InvAssemblyPage {
	...
	@ExcelCollection(name="组装单_明细")
	@ApiModelProperty(value = "组装单_明细")
	private List<InvAssemblyDetail> invAssemblyDetailList;
	@ExcelCollection(name="组装单_材料明细")
	@ApiModelProperty(value = "组装单_材料明细")
	private List<InvAssemblyBomDetail> invAssemblyBomDetailList;

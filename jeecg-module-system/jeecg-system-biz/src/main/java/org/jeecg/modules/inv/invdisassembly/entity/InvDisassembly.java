package org.jeecg.modules.inv.invdisassembly.entity;
 ...
 * @Version: V1.0
 */
@ApiModel(value="inv_disassembly对象", description="拆卸单")
@Data
@TableName("inv_disassembly")
public class InvDisassembly implements Serializable {
	...
	/**拆卸入库*/
	@Excel(name = "拆卸入库", width = 15,dictTable = "sys_depart",dicText = "depart_name",dicCode = "org_code")
    @ApiModelProperty(value = "拆卸入库")
    @Dict(dictTable = "sys_depart",dicText = "depart_name",dicCode = "org_code")
    private String inWarehouseCode;
	/**拆卸出库*/
	@Excel(name = "拆卸出库", width = 15,dictTable = "sys_depart",dicText = "depart_name",dicCode = "org_code")

package org.jeecg.modules.pur.purorder.vo;
...
public class PurOrderPage {
	...
	/**采购类型*/
	@Excel(name = "采购类型", width = 15, dicCode = "dict_pur_order_type")
    @Dict(dicCode = "dict_pur_order_type")
	...
	@ExcelCollection(name="采购订单_明细")
	@ApiModelProperty(value = "采购订单_明细")
	private List<PurOrderDetail> purOrderDetailList;

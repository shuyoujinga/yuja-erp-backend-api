 ...
 */
@Data
@ApiModel(value="inv_issuePage对象", description="物料领用")
public class InvIssuePage {
	...
	@ExcelCollection(name="物料领用_明细")
	@ApiModelProperty(value = "物料领用_明细")
	private List<InvIssueDetail> invIssueDetailList;

package org.jeecg.modules.prd.prdreport.vo;
 ...
 */
@Data
@ApiModel(value="prd_reportPage对象", description="生产报工")
public class PrdReportPage {
...
@Dict(dictTable = "sys_user",dicText = "realname",dicCode = "username")
	...
	@ExcelCollection(name="生产报工_明细")
	@ApiModelProperty(value = "生产报工_明细")
	private List<PrdReportDetail> prdReportDetailList;

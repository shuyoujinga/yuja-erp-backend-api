package org.jeecg.modules.inv.invmiscout.vo;
 ...
 */
@Data
@ApiModel(value="inv_misc_outPage对象", description="其他出库")
public class InvMiscOutPage {
...
@Dict(dictTable = "sys_user",dicText = "realname",dicCode = "username")
	...
	@ExcelCollection(name="其他入库_明细")
	@ApiModelProperty(value = "其他入库_明细")
	private List<InvMiscOutDetail> invMiscOutDetailList;

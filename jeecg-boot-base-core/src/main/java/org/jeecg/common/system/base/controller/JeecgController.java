...
public class JeecgController<T, S extends IService<T>> {
    ...
    /**
     * 自定义数据源的 Excel 导出（用于复杂 SQL）
     */
    protected ModelAndView exportXlsByCustom(HttpServletRequest request, List<?> dataList,
                                             Class<?> clazz, String title) {
    ...
    protected  void  checkQueryParam(Object param) {
